...
//1.practice Swing - basic frame & button
		...
		frm.setBounds(400,200,400,200);	//위치, 크기
		frm.setLayout(new FlowLayout());	//컴포넌트 배치
...
//3.Event listener - 버튼위에 마우스 위치, 버튼 클릭 했을 때 이벤트 잡기	
